...
<input type="date" class="form-control">
    ...
    <div class="panel-body">
      <!--Tabla de contenidos-->
            <section>
         <div class="form-group row">
            <label for="inputState7" class="col-xs-2 form-label">Nombre de la UBP:</label>
 <div class="col-xs-3">
  <select id="inputState7" class="form-control">
    <option selected>Choose...</option>
    <option>...</option>
             ...
             <label for="inputState7" class="col-xs-2 form-label">Nombre de PP: </label>
 <div class="col-xs-5">
<label id="inputState7">Seguimiento del desempeño de la gestion</label>
 </div>
         </div>
      </section>
      <section>
        <div class="row">
          <label>Numero de UBP: 15932</label>
           <div class="col-xs-5">
