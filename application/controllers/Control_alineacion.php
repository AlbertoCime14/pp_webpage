...
class Control_alineacion extends CI_Controller {
	...
	public function inicia_sesion()
	{
		...
		$dependencia_id = $dependencia[0]->id_institucion;
		$depennom = $dependencia[0]->institucion_abrev;
		...
		{
			$datos = array('dependencia_id'=>$dependencia_id, 'institucion_abrev'=>$depennom);
			//$this->session->set_userdata($datos);
			$_SESSION['dependencia_id'] = $dependencia_id;
			$_SESSION['institucion_abrev'] = $depennom;
			echo 'correcto';
		}
