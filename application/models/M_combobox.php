...
class M_combobox extends CI_Model {
    ...
    function consultarExisteFuente($id_actividad,$id_fuente){
      $this->db->select('id_actividad_fuente');
      $this->db->from('s0_actividad_fuente');
      $this->db->where('id_actividad', $id_actividad);
      $this->db->where('id_fuente', $id_fuente);
